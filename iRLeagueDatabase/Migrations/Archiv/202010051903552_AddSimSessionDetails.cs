namespace iRLeagueDatabase.Migrations
{
    ...
    public partial class AddSimSessionDetails : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.ResultRowEntities", "QualifyingTimeAt", c => c.DateTime(nullable: false));
            ...
            AddColumn("dbo.ResultsFilterOptionEntities", "Exclude", c => c.Boolean(nullable: false));
        }
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.ResultsFilterOptionEntities", "Exclude");
